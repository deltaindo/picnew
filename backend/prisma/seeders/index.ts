...
export const trainingProgramSeeds: Omit<TrainingProgramSeed, 'bidangId'>[] = [
  { name: 'AHLI K3 UMUM', description: 'Pelatihan Ahli Keselamatan dan Kesehatan Kerja Umum', durationDays: 12 },
  { name: 'AUDITOR SMK3', description: 'Pelatihan Auditor Sistem Manajemen K3', durationDays: 5 },
  { name: 'K3 KONSTRUKSI', description: 'Pelatihan K3 Konstruksi dan Bangunan', durationDays: 5 },
  { name: 'K3 LISTRIK', description: 'Pelatihan K3 Kelistrikan', durationDays: 5 },
  { name: 'K3 ELEVATOR ESKALATOR', description: 'Pelatihan K3 Elevator dan Eskalator', durationDays: 4 },
  { name: 'K3 KEBAKARAN', description: 'Pelatihan K3 Penanggulangan Kebakaran', durationDays: 4 },
  { name: 'K3 PAA', description: 'Pelatihan K3 Pesawat Angkat dan Angkut', durationDays: 5 },
  { name: 'K3 PTP', description: 'Pelatihan K3 Pesawat Tenaga dan Produksi', durationDays: 5 },
  { name: 'K3 PUBT', description: 'Pelatihan K3 Pesawat Uap dan Bejana Tekanan', durationDays: 5 },
  { name: 'K3 LAS', description: 'Pelatihan K3 Pengelasan', durationDays: 3 },
  { name: 'K3 KIMIA', description: 'Pelatihan K3 Bahan Kimia Berbahaya', durationDays: 4 },
  { name: 'K3 RUANG TERBATAS', description: 'Pelatihan K3 Bekerja di Ruang Terbatas', durationDays: 2 },
  { name: 'K3 PEKERJAAN PADA KETINGGIAN', description: 'Pelatihan K3 Bekerja pada Ketinggian', durationDays: 3 },
  { name: 'K3 KESEHATAN KERJA', description: 'Pelatihan Kesehatan dan Higiene Kerja', durationDays: 4 },
  { name: 'TKBT 2', description: 'Teknisi Keselamatan Bejana Tekan Tingkat 2', durationDays: 5 },
  { name: 'TKBT 1', description: 'Teknisi Keselamatan Bejana Tekan Tingkat 1', durationDays: 4 },
  { name: 'TKPK 1', description: 'Teknisi Keselamatan Pesawat Khusus Tingkat 1', durationDays: 4 },
  { name: 'TKPK 2', description: 'Teknisi Keselamatan Pesawat Khusus Tingkat 2', durationDays: 5 },
];
